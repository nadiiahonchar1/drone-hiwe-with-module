            ...
            <div className={style.description}>
              ...
              <div className={style.aboutProduct}>
                <p>
                  ...
                  постачання дронами за час війни, в наслідок чого з’явилась
                  ідея систематизувати запити і підійти більш системно до
                  комплектації, нових та вже існуючих підрозділів ЗСУ, що в свою
                  чергу дозволяє більш якісно та ефективно виконувати бойові
                  задачі.
                </p>
                <p>
                  ...
                  кількістю задіяних інструментів(в ідеалі без них). Тому
                  особливу увагу ми виділяємо комплектації бортів допоміжними
                  модулями (особливо модулями зв’язку). В якості станцій зв’язку
                  ми віддаємо перевагу ретрансляторах повітряного базування
            ...
            <div className={style.description}>
              <div className={style.aboutProduct}>
                <p>
                  ...
                  повітряного та наземного базування. Віддаємо перевагу модулям
                  ретрансляторів повітряного базування так як вони працюють
                  більш ефективно та менше видають позиції операторів.
                </p>
                <p>
            ...
            <div className={style.description}>
              ...
              <div className={style.aboutProduct}>
                <p>
                  ...
                  КСХН, підсилення в заданому діапазоні частот та інше. На нашу
                  думку якісна антена є чи не найголовнішою запорукою стабільної
                  та якісної роботи каналу радіо зв’язку.
                </p>
                <Button buttonText="Перейти до каталогу" redirectPath="#" />
              </div>
            </div>
            ...
            <div className={style.description}>
              <div className={style.aboutProduct}>
                <p>
                  ...
                  та модулями нашого, вітчизняного або закордонного виробництва
                  такими як: рами, мотори, гвинти, політні контроллери, політні
                  стеки, різноманітні датчики та модулі (від безпечного
                  взведення до важких систем скиду), камери від звичайних до
                  термічних, модулі нічної підсвітки, корпуса та моделі літаків
                  та крил.
                </p>
                <p>
            ...
            <div className={style.description}>
              ...
              <div className={style.aboutProduct}>
                <p>
                  ...
                  розробили цілу лінійку саперних пристроїв що дозволяє зробити
                  роботу кожного сапера – безпечнішою, зручнішою та більш
                  ефективною. З радістю надамо по запиту повний перелік нашої
                  продукції, тож дзвоніть без вагань
                </p>
                <Button buttonText="Перейти до каталогу" redirectPath="#" />
              </div>
            </div>
